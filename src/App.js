...
import {getCalculation} from "./service/index"
...
function App() {
    ...
    const handleSubmit = async () => {
      ...
      try {
        ...
        const _data = {
                        _numbers: processedNumbers, 
                      _target: processedTarget, 
                      _includeDecimals: includeDecimals, 
                      approxMode 
        }

        const data = getCalculation(_data)
